...
const WEBHOOK_URL = process.env.WEBHOOK_URL || 'http://localhost:3000/webhooks/app/subscriptions/update';
const SHOP_DOMAIN = process.env.TEST_SHOP || 'test-shop.myshopify.com';

if (!API_SECRET) {
  console.error('❌ Error: VITE_SHOPIFY_API_SECRET not found in .env file');
  process.exit(1);
}
