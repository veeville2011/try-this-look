...
const API_ENDPOINT = "https://try-on-server-v1-aqjt.onrender.com/api/fashion-photo";
const HEALTH_ENDPOINT = "https://try-on-server-v1-aqjt.onrender.com/api/health";
