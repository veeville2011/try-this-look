...
import { isWidgetTestRoute, isWidgetTestPath, isLocalhost } from '@/testComponents/config/testProductDataV1';
...
const VirtualTryOnModalV1: React.FC<VirtualTryOnModalProps> = ({ customerInfo }) => {
                    ...
                    <div className="w-full rounded-xl bg-gradient-to-br from-white to-muted/20 border-2 border-border/60 overflow-hidden relative flex-1 min-h-[200px] max-h-[300px] shadow-inner group/image-container">
                      ...
                      >
                        ...
                        <div className="w-1/4 h-full flex-shrink-0 flex items-center justify-center relative p-3">
                          <img 
                            src="https://hemanthavisi-nusense-tryon.s3.eu-north-1.amazonaws.com/promod_demo/person/1766486097276_7ccdb71b41929e63_blob.jpeg" 
                        ...
                        <div className="w-1/4 h-full flex-shrink-0 flex items-center justify-center relative p-3">
                          <img 
                            src="https://hemanthavisi-nusense-tryon.s3.eu-north-1.amazonaws.com/promod_demo/clothing/1766486098288_f4f3ba85d9bffba7_clothing-item.jpg.jpeg" 
                        ...
                        <div className="w-1/4 h-full flex-shrink-0 flex items-center justify-center relative p-3">
                          <img 
                            src="https://hemanthavisi-nusense-tryon.s3.eu-north-1.amazonaws.com/promod_demo/generated/1766486128492_c34538c6d298c0db_generated_iqw81yvt6.jpeg" 
...
export default VirtualTryOnModalV1;
