                          ...
                          <div className="flex-1 min-w-0 pt-1">
                            <div className="flex items-start gap-4 mb-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-base sm:text-lg text-foreground/90 mb-4 sm:mb-5 leading-relaxed no-orphans">
                                  Le bloc d'application se place directement
                                  dans vos sections de page produit. Il est
                                ...
                                <div className="space-y-4 mb-4 sm:mb-5">
                                  <div className="bg-muted rounded-lg p-4 sm:p-5 border-2 border-border">
                                    ...
                                    <ol className="list-decimal list-inside space-y-2 text-sm sm:text-base text-foreground/90">
                                      ...
                                      <li className="no-orphans">
                                        Personnalisez le texte du bouton, le
                                        style et les autres paramètres
                                      </li>
                                      <li className="no-orphans">
                                        Réorganisez le bloc en le faisant
                                        glisser si nécessaire puis cliquez sur{" "}
                                        <strong className="font-bold text-foreground">
                                          Enregistrer
                                        </strong>
                                      </li>
                                  ...
                                  <div className="bg-warning/20 border-2 border-warning/40 rounded-lg p-4 sm:p-5">
                                    <p className="text-sm sm:text-base text-foreground flex items-start gap-3 leading-relaxed">
                                      ...
                                      <span className="no-orphans">
                                        ...
                                        uniquement sur les thèmes Online Store
                                        2.0 (modèles JSON). Mettez à jour votre
                                        thème si nécessaire.
                                      </span>
                                    </p>
                                  </div>
                            ...
                            <div className="flex items-start gap-4 mb-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-base sm:text-lg text-foreground/90 mb-4 sm:mb-5 leading-relaxed no-orphans">
                                  ...
                                  promouvoir la fonctionnalité d'essayage
                                  virtuel. Elle est compatible avec tous les
                                  thèmes{" "}
                                  <strong className="font-bold text-foreground">
                                    Online&nbsp;Store&nbsp;2.0
                                  </strong>
                                ...
                                <div className="space-y-4 mb-4 sm:mb-5">
                                  <div className="bg-muted rounded-lg p-4 sm:p-5 border-2 border-border">
                                    ...
                                    <ol className="list-decimal list-inside space-y-2 text-sm sm:text-base text-foreground/90">
                                      ...
                                      <li className="no-orphans">
                                        La bannière apparaîtra automatiquement
                                        sur votre page d'accueil. Cliquez sur{" "}
                                        <strong className="font-bold text-foreground">
                                          Enregistrer
                                        </strong>
                                      </li>
                                  ...
                                  <div className="bg-info/20 border-2 border-info/40 rounded-lg p-4 sm:p-5">
                                    <p className="text-sm sm:text-base text-foreground flex items-start gap-3 leading-relaxed">
                                      ...
                                      <span className="no-orphans">
                                        ...
                                        préférence sera mémorisée pour la
                                        session.
                                      </span>
                                    </p>
                                  </div>
                          ...
                          <div className="flex-1 min-w-0 pt-1">
                            <div className="flex items-start gap-4 mb-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-base sm:text-lg text-foreground/90 mb-4 sm:mb-5 leading-relaxed no-orphans">
                                  Visitez votre page d'accueil et une page
                                  produit de votre boutique pour vérifier que la
                                  bannière et le bouton d'essayage virtuel
                                  apparaissent correctement. Cliquez sur les
                                  éléments pour tester la fonctionnalité.
                                </p>
